...
import org.casinocoin.net.AbstractTimeoutHandler;
import org.casinocoin.net.MessageWriteTarget;
import org.casinocoin.net.StreamParser;
 ...
 * {@link com.google.casinocoin.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamParser {
     ...
     * called automatically by {@link org.casinocoin.net.NioClient} or
     * {@link org.casinocoin.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
