 ...
 *
 * <p>Bitcoin transactions don't specify what they do directly. Instead <a href="https://en.casinocoin.it/wiki/Script">a
...
public class Script {
    ...
    public String toString() {
        ...
        for (ScriptChunk chunk : chunks) {
            if (chunk.isOpCode()) {
                buf.append(ScriptOpCodes.getOpCodeName(chunk.data[0]));
                buf.append(" ");
            } else {
                // Data chunk
                buf.append("[");
    ...
    public byte[] getPubKey() throws ScriptException {
        ...
        if (chunks.get(0).data.length > 2 && chunks.get(1).data.length > 2) {
            ...
            return chunks.get(1).data;
        } else if (chunks.get(1).data.length == 1 && chunks.get(1).equalsOpCode(ScriptOpCodes.OP_CHECKSIG) && chunks.get(0).data.length > 2) {
     ...
     * logic is defined by <a href="https://github.com/casinocoin/bips/blob/master/bip-0016.mediawiki">BIP 16</a>.</p>
     *
