...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link org.casinocoin.core.BlockChain#getChainHead()}
     * or perhaps {@link org.casinocoin.core.BlockChain#getBestChainHeight()} which will run in constant time and
