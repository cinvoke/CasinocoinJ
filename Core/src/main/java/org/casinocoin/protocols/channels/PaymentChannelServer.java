...
import org.casinocoin.paymentchannel.Protos;
...
public class PaymentChannelServer {
     ...
     *                               between a few bitcents and a casinocoin.
    ...
    private void receiveVersionMessage(Protos.TwoWayChannelMessage msg) throws VerificationException {
        ...
        if (msg.getClientVersion().getMajor() != 1) {
            error("This server needs protocol v1", Protos.Error.ErrorCode.NO_ACCEPTABLE_VERSION,
                    PaymentChannelCloseException.CloseReason.NO_ACCEPTABLE_VERSION);
            return;
        }
     ...
     * {@link ServerConnection#destroyConnection(org.casinocoin.protocols.channels.PaymentChannelCloseException.CloseReason)} or
     ...
     * {@link ServerConnection#destroyConnection(org.casinocoin.protocols.channels.PaymentChannelCloseException.CloseReason)}. Note that this does not broadcast
