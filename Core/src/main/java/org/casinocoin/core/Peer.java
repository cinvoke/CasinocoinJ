 ...
 * {@link org.casinocoin.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.casinocoin.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
    ...
    private static class GetDataRequest {
        ...
        // a nasty hack that relies on the fact that casinocoin-qt is single threaded and processes messages in order.
     ...
     * {@link org.casinocoin.net.NioClientManager#openConnection(java.net.SocketAddress, org.casinocoin.net.StreamParser)}
     * or
     * {@link org.casinocoin.net.NioClient#NioClient(java.net.SocketAddress, org.casinocoin.net.StreamParser, int)}.</p>
     *
   ...
   /**
    ...
    private void blockChainDownloadLocked(Sha256Hash toHash) {
        ...
        //
        //   https://en.casinocoin.it/wiki/Protocol_specification#getblocks
        //
