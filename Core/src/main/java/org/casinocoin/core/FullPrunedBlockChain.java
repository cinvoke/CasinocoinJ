...
/**
 * <p>A FullPrunedBlockChain works in conjunction with a {@link org.casinocoin.store.FullPrunedBlockStore} to verify all the rules of the
    ...
    protected TransactionOutputChanges connectTransactions(int height, Block block)
        ...
        try {
            if (!params.isCheckpoint(height)) {
                ...
                // BIP30 document for more details on this: https://github.com/casinocoin/bips/blob/master/bip-0030.mediawiki
