...
package org.casinocoin.protocols.channels;

import org.casinocoin.crypto.TransactionSignature;
import org.casinocoin.script.Script;
import org.casinocoin.script.ScriptBuilder;
import org.casinocoin.utils.Threading;
import org.casinocoin.wallet.AllowUnconfirmedCoinSelector;
 ...
 * You must then call {@link PaymentChannelClientState#storeChannelInWallet(org.casinocoin.core.Sha256Hash)} to store the refund transaction
...
public class PaymentChannelClientState {
     ...
     *              It is suggested you use at least {@link org.casinocoin.core.Utils#CENT} to avoid paying fees if you need to spend the refund transaction
     ...
     * overriding {@link PaymentChannelClientState#editContractSendRequest(org.casinocoin.core.Wallet.SendRequest)}.
     * By default unconfirmed coins are allowed to be used, as for micropayments the risk should be relatively low.
     *
     * @throws ValueOutOfRangeException if the value being used is too small to be accepted by the network
     * @throws org.casinocoin.core.InsufficientMoneyException if the wallet doesn't contain enough balance to initiate
     */
     ...
     * later.
     *
     * @see PaymentChannelClientState#storeChannelInWallet(org.casinocoin.core.Sha256Hash)
     */
