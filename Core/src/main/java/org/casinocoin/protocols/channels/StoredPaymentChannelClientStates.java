 ...
 * and broadcasting the refund transaction over the given {@link org.casinocoin.core.TransactionBroadcaster}.
 */
    ...
    public byte[] serializeWalletExtension() {
        ...
        try {
            ...
            for (StoredClientChannel channel : mapChannels.values()) {
                ...
                Preconditions.checkNotNull(channel.myKey.getPrivKeyBytes());
