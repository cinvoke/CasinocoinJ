...
package org.casinocoin.testing;

import org.casinocoin.params.UnitTestParams;
import org.casinocoin.store.BlockStore;
import org.casinocoin.store.MemoryBlockStore;
import org.casinocoin.utils.BriefLogFormatter;
...
import static org.casinocoin.testing.FakeTxBuilder.createFakeBlock;
import static org.casinocoin.testing.FakeTxBuilder.createFakeTx;
 ...
 * with fees (a good idea!) make sure you set the {@link org.casinocoin.core.Wallet.SendRequest#DEFAULT_FEE_PER_KB} value to
 * {@link org.casinocoin.core.Transaction#REFERENCE_DEFAULT_MIN_TX_FEE} before doing so.
 */
