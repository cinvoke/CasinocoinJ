...
package org.casinocoin.protocols.payments;

import org.casinocoin.crypto.TrustStoreLoader;
...
import org.casinocoin.protocols.payments.Protos;
 ...
 *
 * <ul>
 * <li>A {@link org.casinocoin.uri.BitcoinURI} object that conforms to BIP 0072</li>
 ...
 * transactions to the casinocoin network. Instead it returns a ListenableFuture that will be notified when a
 ...
 *
 * @see <a href="https://github.com/casinocoin/bips/blob/master/bip-0070.mediawiki">BIP 0070</a>
 */
public class PaymentSession {
    ...
    /**
     * Returns a {@link org.casinocoin.core.Wallet.SendRequest} suitable for broadcasting to the network.
     */
     ...
     * NOTE: This does not broadcast the transactions to the casinocoin network, it merely sends a Payment message to the
