...
import org.casinocoin.protocols.payments.PaymentProtocol;
...
/** Takes a URL or casinocoin URI and prints information about the payment request. */
public class PaymentProtocolTool {
    public static void main(String[] args) {
        if (args.length < 1) {
            System.err.println("Provide a casinocoin URI or URL as the argument.");
            return;
        }
        dump(args[0]);
    }
