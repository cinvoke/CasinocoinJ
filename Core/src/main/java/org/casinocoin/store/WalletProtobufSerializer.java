...
import org.casinocoin.wallet.Protos;
 ...
 * format is defined by the <tt>casinocoin.proto</tt> file in the bitcoinj source distribution.<p>
 *
...
public class WalletProtobufSerializer {
    ...
    private WalletTransaction connectTransactionOutputs(org.casinocoin.wallet.Protos.Transaction txProto) throws UnreadableWalletException {
    ...
    private void readConfidence(Transaction tx, Protos.TransactionConfidence confidenceProto,
        ...
        switch (confidenceProto.getType()) {
            case BUILDING: confidenceType = TransactionConfidence.ConfidenceType.BUILDING; break;
            case DEAD: confidenceType = TransactionConfidence.ConfidenceType.DEAD; break;
            // These two are equivalent (must be able to read old wallets).
            case NOT_IN_BEST_CHAIN: confidenceType = TransactionConfidence.ConfidenceType.PENDING; break;
            case PENDING: confidenceType = TransactionConfidence.ConfidenceType.PENDING; break;
            case UNKNOWN:
                // Fall through.
            default:
