 ...
 * one for the main network ({@link org.casinocoin.params.MainNetParams}), one for the public test network, and two others that are
...
public abstract class NetworkParameters implements Serializable {
    ...
    public static final String ID_MAINNET = CoinDefinition.ID_MAINNET; //"org.casinocoin.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = CoinDefinition.ID_TESTNET; //"org.casinocoin.test";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = CoinDefinition.ID_UNITTESTNET; //"com.google.casinocoin.unittest";
