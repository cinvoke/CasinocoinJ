...
import org.casinocoin.core.StoredTransactionOutput;
import org.casinocoin.core.StoredUndoableBlock;

/**
 * <p>An implementor of FullPrunedBlockStore saves StoredBlock objects to some storage mechanism.</p>
 * 
 * <p>In addition to keeping tack of a chain using {@link org.casinocoin.core.StoredBlock}s, it should also keep track of a second
 * copy of the chain which holds {@link org.casinocoin.core.StoredUndoableBlock}s. In this way, an application can perform a
 ...
 * 
 * <p>It should store the {@link org.casinocoin.core.StoredUndoableBlock}s of a number of recent blocks before verifiedHead.height and
 * all those after verifiedHead.height.
 * It is advisable to store any {@link org.casinocoin.core.StoredUndoableBlock} which has a height > verifiedHead.height - N.
 ...
 * 
 * <p>It must store the {@link org.casinocoin.core.StoredBlock} of all blocks.</p>
 *
...
public interface FullPrunedBlockStore extends BlockStore {
    /**
     * <p>Saves the given {@link org.casinocoin.core.StoredUndoableBlock} and {@link org.casinocoin.core.StoredBlock}. Calculates keys from the {@link org.casinocoin.core.StoredBlock}</p>
     * 
    ...
    /**
     * Gets a {@link org.casinocoin.core.StoredTransactionOutput} with the given hash and index, or null if none is found
     */
