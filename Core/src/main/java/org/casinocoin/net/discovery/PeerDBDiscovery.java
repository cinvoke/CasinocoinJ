...
package org.casinocoin.net.discovery;
...
public class PeerDBDiscovery implements PeerDiscovery {
    ...
    /**
     * Creates a PeerDB for the given {@link org.casinocoin.core.PeerGroup}, adding this as a PeerDiscovery to the given group.
     */
    ...
    /**
     * Attaches a {@link org.casinocoin.core.PeerEventListener} to the given {@link PeerGroup} which listens for {@link org.casinocoin.core.AddressMessage}
