 ...
 * Used as part of the implementation of {@link org.casinocoin.core.Wallet#setKeyRotationTime(java.util.Date)}.
 */
public class KeyTimeCoinSelector implements CoinSelector {
    ...
    /** A number of inputs chosen to avoid hitting {@link org.casinocoin.core.Transaction.MAX_STANDARD_TX_SIZE} */
