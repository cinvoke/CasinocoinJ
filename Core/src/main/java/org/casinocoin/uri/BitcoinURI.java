 ...
 *
 * <ul>
 * <li>{@code casinocoin:<address>}</li>
 * <li>{@code casinocoin:<address>?<name1>=<value1>&<name2>=<value2>} with multiple
 ...
 * @see <a href="https://github.com/casinocoin/bips/blob/master/bip-0021.mediawiki">BIP 0021</a>
 */
public class BitcoinURI {
    ...
    public BitcoinURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        ...
        // URI is formed as  casinocoin:<address>?<query parameters>
        // blockchain.info generates URIs of non-BIP compliant form casinocoin://address?....
        // We support both until Ben fixes his code.
        
        // Remove the casinocoin scheme.
        // (Note: getSchemeSpecificPart() is not used as it unescapes the label and parse then fails.
        // For instance with : casinocoin:129mVqKUmJ9uwPxKJBnNdABbuaaNfho4Ha?amount=0.06&label=Tom%20%26%20Jerry
